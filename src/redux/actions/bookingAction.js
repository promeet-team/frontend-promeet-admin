...
export const getBookingAction = ()  => {
    return async (dispatch) => {
        ...
        .get('https://server-promeet.herokuapp.com/api/admin/data/booking');
...
export const getBookingDetailAction = (id) => {
    return async(dispatch) => {
        const response = await Axios 
        .get(`https://server-promeet.herokuapp.com/api/admin/data/booking/${id}`);
 ...
 export const getEditBookingAction = (status, event, id) => {
    return async(dispatch) => {    
        ...
        return Axios
        .put(`https://server-promeet.herokuapp.com/api/admin/edit-booking/${id}`, status)
        .then((response) => {
